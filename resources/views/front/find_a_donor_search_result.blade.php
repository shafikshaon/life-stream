...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      <h4>Total <span style="color: green;">{{$profiles->count()}}</span>  donor(s) found</h4>
      <br>
    @if ($profiles->count() > 0)
    ...
    <div class="media text-left p-2 user-grid mb-3 rounded-right">
      ...
      @endforeach
    @else
      <p class="text-danger">Sorry! No donor have been found</p>
    @endif
      <div class="pagination justify-content-end">
        {{ $profiles->appends(['blood_group' => Request::get('blood_group'), 'district' => Request::get('district'), 'upazila' => Request::get('upazila')])->links() }}
      </div>
    </div>
  </div>
</div>
